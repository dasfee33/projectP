...
public class UI_PlayersInfoPopup : UI_Popup
{
    enum GameObjects
    {
        CloseArea,
    ...
    int _heroDataId = -1;
    PlayerSaveData SaveData { get { return Managers.Game.AllPlayers.Find(h => h.DataId == _heroDataId); } }
    ...
    void Refresh()
    {
        ...
        Data.PlayerData data = Managers.Data.PlayerDic[_heroDataId];

...
public class EffectComponent : MonoBehaviour
{
    ...
    public List<EffectBase> GenerateEffects(IEnumerable<int> effectIds, EffectSpawnTypes spawnType, SkillBase skill)
    {
    ...
    public void ClearDebuffsBySkill()
    {
        ...
        {
            if (buff.EffectType != EffectTypes.Buff)
            {
                buff.ClearEffect(EffectClearTypes.ClearSkill);
            }
        }
    }
}

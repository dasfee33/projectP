...
public class InventoryManager
{
    ...
    public Item MakeItem(int itemTemplateId, int count = 1)
    {
        ...
        ItemSaveData saveData = new ItemSaveData() {
            ...
            Count = count,
            EquipSlot = (int)EquipSlotTypes.Inventory,
            EnchantCount = 0,
        };
    ...
    public void EquipItem(int instanceId)
    {
        ...
        EquipSlotTypes equipSlotType = item.GetEquipItemEquipSlot();
        if (equipSlotType == EquipSlotTypes.None)
            return;
    ...
    public void UnEquipItem(int instanceId, bool checkFull = true)
    {
        ...
        item.EquipSlot = (int)EquipSlotTypes.Inventory;
        InventoryItems.Add(item);
    }
    ...
    public Item GetEquippedItem(EquipSlotTypes equipSlotType)
    {
    ...
    public Item GetEquippedItemBySubType(ItemSubTypes subType)
    {

...
{
    private AudioSource[] _audioSources = new AudioSource[(int)Define.Sounds.Max];
    ...
    public void Init()
    {
        if (_soundRoot == null)
        {
            ...
            if (_soundRoot == null)
            {
                ...
                string[] soundTypeNames = System.Enum.GetNames(typeof(Define.Sounds));
    ...
    public void Play(Define.Sounds type)
    {
        AudioSource audioSource = _audioSources[(int)type];
        audioSource.Play();
    }

    public void Play(Define.Sounds type, string key, float pitch = 1.0f)
    {
        AudioSource audioSource = _audioSources[(int)type];
    ...
    public void Play(Define.Sounds type, AudioClip audioClip, float pitch = 1.0f)
    {
        AudioSource audioSource = _audioSources[(int)type];

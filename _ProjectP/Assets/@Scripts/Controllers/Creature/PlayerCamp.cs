...
public class PlayerCamp : BaseObject
{
    ...
    public override bool Init()
    {
        ...
        Collider.includeLayers = (1 << (int)Define.Layers.Obstacle);
        Collider.excludeLayers = (1 << (int)Define.Layers.Monster) | (1 << (int)Define.Layers.Player);

        ObjectType = Define.ObjectTypes.PlayerCamp;
